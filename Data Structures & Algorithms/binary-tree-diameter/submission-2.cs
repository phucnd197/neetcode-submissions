...
public class Solution {
    public int DiameterOfBinaryTree(TreeNode root) 
    {
        ...
        var fromRootToLeft = countFromRoot + left;
        var fromRootToRight = countFromRoot + right;
        var fromLeftToRight = left + right;
        return Math.Max(Math.Max(fromRootToLeft, fromRootToRight), fromLeftToRight);
    }
